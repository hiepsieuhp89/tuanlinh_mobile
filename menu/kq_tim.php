...
//--------------------------tim nhanh-------------------
$tukhoa = isset($_POST["tim"]) ? $_POST["tim"]: "";
	$dieukien = "";
	if($tukhoa != "")
	$dieukien = " tensp like '%$tukhoa%' OR mota like '%$tukhoa%'";
...
//-----------------------------Xử lý phân trang--------------------
	...
	//------------------------------------------------------
	$sql = "SELECT `masp`, `tensp`,  `hinhanh`, `dongia`,`khuyenmai` FROM `sanpham` $dieukien LIMIT $dongbatdau, $kichthuoctrang;";
...
<div id="center">
  ...
  <div class="noi_dung_chinh">
      <h3 class="cat_title">Kết quả :<?= $tongsodong?>sản phẩm</h3>
