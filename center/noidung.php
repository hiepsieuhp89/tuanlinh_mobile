...
//trang lien ket voi menu trai
	...
	$tenloai=isset($_GET["TL"]) ? $_GET["TL"] : "" ;
	$tensp = "";
	if ($tenloai!= "")
	$tensp="Điện thoại $tenloai";
	else $tensp=" sản phẩm mới";
...
//---------------------------Xử lý phân trang--------------------
	...
	$sql = "Select masp From sanpham INNER JOIN loaisp ON sanpham.maloai=loaisp.maloai  $dieu_kien and manhom=1; ";
	...
	//------------------------------------------------------
	$sql = "SELECT `masp`, `tensp`,  `hinhanh`, `dongia`,`khuyenmai`,sanpham.maloai,tenloai FROM `sanpham` INNER JOIN loaisp ON sanpham.maloai=loaisp.maloai  $dieu_kien and manhom=1 LIMIT $dongbatdau, $kichthuoctrang;";
