...
//---------------------------Xử lý phân trang--------------------
	...
	$sql = "Select masp From sanpham where khuyenmai>0";
	...
	//------------------------------------------------------
	$sql = "SELECT `masp`, `tensp`,  `hinhanh`, `dongia`,`khuyenmai` from sanpham where khuyenmai>0 LIMIT $dongbatdau, $kichthuoctrang;";
